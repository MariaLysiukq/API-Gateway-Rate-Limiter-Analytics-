...
# 2. Import your Base and ALL models here so Alembic can see them
from src.db.database import Base
from src.db.models import User, APIKey, RequestLog

# this is the Alembic Config object
config = context.config

# 3. Dynamically set the database URL
...
def do_run_migrations(connection):
    """Синхронна функція, яку викликає асинхронний контекст."""
